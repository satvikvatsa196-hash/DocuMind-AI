...
SECRET_KEY = "django-insecure-**dvt--ifdht@v#wa$t^#5!lt4lk20s4fnjz@s5s@ac3s_&+t+"
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.environ.get("DB_PASSWORD", "documind_password"),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'RAG Backend API for DocuMind AI Knowledge Assistant',
    'VERSION': '1.0.0',
